    ...
    <div className="pt-24">
      ...
      <section className="relative min-h-screen flex items-center px-6 md:px-20 overflow-hidden">
        <div className="z-10 max-w-4xl">
          <p className="text-[12px] tracking-[0.3em] uppercase text-brand-gold mb-6 font-medium">ESTABLISHED 2014</p>
          <h1 className="text-6xl md:text-9xl font-serif font-bold tracking-tighter leading-none mb-12 text-white">
        ...
        <div className="absolute right-0 top-0 w-1/2 h-full opacity-40 grayscale">
          <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
          ...
          <div className="md:col-span-7 order-1 md:order-2 flex flex-col justify-center">
            ...
            <div className="space-y-8 text-brand-muted text-lg leading-relaxed max-w-xl font-light">
              <p>
                Konnection Studio began in a repurposed textile mill, born from a singular obsession: to strip away the noise and focus on the fundamental geometry of light and shadow. We don't just capture images; we construct visual monoliths.
              </p>
              <p>
              ...
              <div className="pt-8">
                <button className="inline-flex items-center text-brand-gold group gap-4">
      ...
      <section className="py-60 px-6 flex flex-col items-center text-center">
        ...
        <cite className="mt-12 text-sm tracking-[0.4em] uppercase text-brand-muted not-italic">— KONNECTION MANIFESTO</cite>
      </section>
      ...
      <section className="py-40 px-6 md:px-20">
        <div className="flex justify-between items-end mb-24">
          <div>
            ...
            <h2 className="text-5xl font-serif text-white tracking-tight">Core Collective</h2>
          </div>
